      ...
      {open && menuPos && createPortal(
        ...
        >
          <button
            ...
            onClick={e => { e.stopPropagation(); changeStatus('activo'); }}
          >
            Marcar como Activo
          </button>
          <button
            ...
            onClick={e => { e.stopPropagation(); changeStatus('compro'); }}
          >
            Marcar como Compró
          </button>
          <button
            ...
            onClick={e => { e.stopPropagation(); changeStatus('descartado'); }}
          >
          ...
          <button
            ...
            onClick={e => { e.stopPropagation(); changeStatus('seguimiento'); }}
          >
          ...
          {filtered.map(buyer => (
            ...
            <Card className="hover:shadow-md transition-all">
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex gap-2">
                ...
                <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all" onClick={(e) => { e.stopPropagation(); openForm(buyer); }} title="Editar">
                  <Edit3 size={16} />
                </button>
                ...
                <button className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all" onClick={(e) => { e.stopPropagation(); handleDelete(buyer.id); }} title="Eliminar">
                  <Trash2 size={16} />
                </button>
              </div>
            </Card>
