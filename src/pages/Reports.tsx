...
export default function Reports() {
  ...
  const monthlyVisits = events.filter(
    (e) =>
      e.type === "visita" &&
  ...
  const conversionRate =
    activeOps.length > 0
      ? Math.round((closedOps.length / activeOps.length) * 100)
      : 0;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">
            Visualiza el rendimiento de tu negocio inmobiliario.
          </p>
        </div>
          ...
          <Card title="Origen de Clientes">
            <div className="h-[250px] relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                ...
                <p className="text-[10px] font-black text-slate-400 dark:text-slate-500 tracking-widest uppercase">
                  Canales
                </p>
              </div>
            </div>
          ...
          <Card title="Estado de Propiedades">
            <div className="space-y-4">
              <ProgressItem
                ...
                value={
                  Math.round(
                    (properties.filter((p) => p.operation === "venta").length /
                      properties.length) *
                      100,
                  ) || 0
                }
              ...
              <ProgressItem
                ...
                value={
                  Math.round(
                    (sales.filter((s) => s.estado === "activa").length /
                      sales.length) *
                      100,
                  ) || 0
                }
  ...
  return (
    <Card className="p-5 flex flex-col">
      ...
      >
        ...
        {trend}{" "}
        <span className="text-slate-400 dark:text-slate-500 ml-1 font-medium italic">
          vs mes ant.
        </span>
      </div>
    </Card>
